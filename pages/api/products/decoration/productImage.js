...
export default async function handler(req, res) {
  try {
    ...
    console.log('Received a POST request to /api/products/decoration/productImage');
    ...
    upload.single('photo')(req, res, async function (err) {
      ...
      const decorationProductName = req.headers['image-name'];
      const destFileName = `${decorationProductName}.jpg`; // Assuming it's a JPEG image
