...
export default async function handler(req, res) {
  try {
    ...
    console.log('Received a POST request to /api/projects/interiors/projectImage');
    ...
    upload.single('photo')(req, res, async function (err) {
      ...
      const interiorsProjectName = req.headers['image-name'];
      const destFileName = `${interiorsProjectName}.jpg`; // Assuming it's a JPEG image
