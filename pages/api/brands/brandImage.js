...
export default async function handler(req, res) {
  try {
    ...
    console.log('Received a POST request to /api/brands/brandImage');
    ...
    upload.single('photo')(req, res, async function (err) {
      ...
      const brandName = req.headers['image-name'];
      const destFileName = `${brandName}.jpg`; // Assuming it's a JPEG image
